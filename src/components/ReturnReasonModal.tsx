...
export const ReturnReasonModal: React.FC<ReturnReasonModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[9999]" onClick={handleBackgroundClick}>
        ...
        <div className="p-6">
          <div className="mb-6 grid grid-cols-1 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="p-3 rounded-lg border bg-red-50 border-red-200 text-red-800">
                <div className="flex items-center">
                  ...
                  <span className="font-medium">{returnItem.returnReason}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <textarea
                id="detailReason"
                className="w-full border border-gray-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all min-h-[150px]"
                value={detailReason}
                onChange={(e) => setDetailReason(e.target.value)}
                placeholder="파손 및 불량에 대한 상세 사유를 작성해주세요. 이 내용은 반품사유에 '파손 및 불량(상세사유)'로 표시됩니다."
              />
            </div>
          </div>
        </div>
