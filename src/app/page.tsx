    ...
    <main className="min-h-screen p-4 md:p-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 mb-6">
        ...
        <button
          ...
          onClick={() => setShowCurrentSettings(true)}
          disabled={loading}
        >
          현재 설정값 보기
        </button>
      ...
      {showCurrentSettings && (
        <div 
          className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
          style={{ zIndex: 1000 + modalLevel }}
          onClick={() => setShowCurrentSettings(false)}
        >
          <div 
          ...
          >
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-4 text-white">
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-semibold">현재 프로필 설정값</h3>
                <button 
                  onClick={() => setShowCurrentSettings(false)} 
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">테이블 설정</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <h5 className="font-medium text-gray-700">팝업 테이블 설정</h5>
                      <div className="text-sm space-y-1">
                        <div><span className="font-medium">팝업 너비:</span> {tableSettings.popupWidth}vw</div>
                        <div><span className="font-medium">팝업 높이:</span> {tableSettings.popupHeight}vh</div>
                        <div><span className="font-medium">테이블 폰트 크기:</span> {tableSettings.popupTableFontSize}rem</div>
                        <div><span className="font-medium">바코드 폰트 크기:</span> {tableSettings.popupBarcodeFontSize}rem</div>
                        <div><span className="font-medium">셀 패딩:</span> {tableSettings.popupCellPadding}rem</div>
                        <div><span className="font-medium">줄 높이:</span> {tableSettings.popupLineHeight}</div>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <h5 className="font-medium text-gray-700">메인 테이블 설정</h5>
                      <div className="text-sm space-y-1">
                        <div><span className="font-medium">테이블 폰트 크기:</span> {tableSettings.mainTableFontSize}rem</div>
                        <div><span className="font-medium">바코드 폰트 크기:</span> {tableSettings.mainBarcodeFontSize}rem</div>
                        <div><span className="font-medium">셀 패딩:</span> {tableSettings.mainCellPadding}rem</div>
                        <div><span className="font-medium">줄 높이:</span> {tableSettings.mainLineHeight}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* 컬럼 정렬 설정 */}
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">컬럼 정렬 설정</h4>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                    {Object.entries(tableSettings.columnAlignment).map(([column, alignment]) => (
                      <div key={column} className="flex justify-between">
                        <span className="font-medium">{column}:</span>
                        <span className="text-blue-600">{alignment}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {/* 컬럼 너비 설정 */}
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">컬럼 너비 설정</h4>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                    {Object.entries(tableSettings.columnWidths).map(([column, width]) => (
                      <div key={column} className="flex justify-between">
                        <span className="font-medium">{column}:</span>
                ...
                {/* 자동 텍스트 크기 설정 */}
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">자동 텍스트 크기 설정</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">활성화:</span>
                        <span className={tableSettings.autoTextSize.enabled ? "text-green-600" : "text-red-600"}>
                          {tableSettings.autoTextSize.enabled ? "활성화" : "비활성화"}
                        </span>
                      </div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">오버플로우 조정:</span>
                        <span className={tableSettings.autoTextSize.adjustForOverflow ? "text-green-600" : "text-red-600"}>
                          {tableSettings.autoTextSize.adjustForOverflow ? "활성화" : "비활성화"}
                        </span>
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">최소 폰트 크기:</span>
                        <span className="text-blue-600">{tableSettings.autoTextSize.minFontSize}rem</span>
                      </div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">최대 폰트 크기:</span>
                        <span className="text-blue-600">{tableSettings.autoTextSize.maxFontSize}rem</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* 바코드 형식 설정 */}
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">바코드 형식 설정</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">활성화:</span>
                        <span className={tableSettings.barcodeFormat.enabled ? "text-green-600" : "text-red-600"}>
                          {tableSettings.barcodeFormat.enabled ? "활성화" : "비활성화"}
                        </span>
                      </div>
                    </div>
                    <div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">메인 코드 크기:</span>
                        <span className="text-blue-600">{tableSettings.barcodeFormat.mainCodeSize}rem</span>
                      </div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">서브 정보 크기:</span>
                        <span className="text-blue-600">{tableSettings.barcodeFormat.subInfoSize}rem</span>
                      </div>
                      <div className="flex justify-between mb-1">
                        <span className="font-medium">줄 간격:</span>
                        <span className="text-blue-600">{tableSettings.barcodeFormat.lineHeight}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* 버튼 색상 설정 */}
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">버튼 색상 설정</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    {Object.entries(buttonColors).map(([button, color]) => (
                      <div key={button} className="flex justify-between items-center">
                        <span className="font-medium">{button}:</span>
                        <div className="flex items-center space-x-2">
                          <div 
                            className="w-4 h-4 rounded border"
                            style={{ backgroundColor: color.includes('blue') ? '#3b82f6' : 
                ...
                {/* 로컬 스토리지 정보 */}
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">로컬 스토리지 정보</h4>
                  <div className="text-sm space-y-2">
                    <div>
                      <span className="font-medium">프로필 ID:</span> 
                      <span className="ml-2 text-blue-600">{navigator.userAgent.slice(-10)}</span>
                    </div>
                    <div>
                      <span className="font-medium">브라우저:</span> 
                      <span className="ml-2 text-gray-600">{navigator.userAgent.split(' ').slice(-2).join(' ')}</span>
                    </div>
                    <div>
